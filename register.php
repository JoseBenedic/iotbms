...
$first_name = htmlspecialchars(mysqli_real_escape_string($conn, $_POST['inputFirstName']));
$last_name = htmlspecialchars(mysqli_real_escape_string($conn, $_POST['inputLastName']));
$email = filter_var(mysqli_real_escape_string($conn, $_POST['inputEmail']), FILTER_SANITIZE_EMAIL);
$password = htmlspecialchars(mysqli_real_escape_string($conn, $_POST['inputPassword']));
...
// Insert the user input into the login_tbl table
$sql = "INSERT INTO login_tbl (FN, LN, email, password)
